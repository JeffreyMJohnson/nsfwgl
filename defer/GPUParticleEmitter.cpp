...
{
	//create a shader
	unsigned int vertexShader = LoadShader(GL_VERTEX_SHADER, "./shaders/gpuParticleUpdate_vert.glsl");
...
{
	unsigned int vertexShader = LoadShader(GL_VERTEX_SHADER, "./shaders/gpuParticle_vert.glsl");
	unsigned int geometryShader = LoadShader(GL_GEOMETRY_SHADER, "./shaders/gpuParticle_geom.glsl");
	unsigned int fragmentShader = LoadShader(GL_FRAGMENT_SHADER, "./shaders/gpuParticle_frag.glsl");
